...
{% endcomment %}
{% for m in site.data.minicourses %}{% capture people %}{% for a in m.collaborators %}{% assign u = site.data.collaborators[a] %}{% if u %}[{{ a }}]({{ u }}){% else %}{{ a }}{% endif %}{% unless forloop.last %}, {% endunless %}{% endfor %}{% endcapture -%}
